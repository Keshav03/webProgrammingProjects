    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profiles', models.ManyToManyField(to='hobbies.Profile')),
            ],
        ),
        migrations.CreateModel(
            name='FriendsRequest',
        ...
        migrations.AddField(
            model_name='user',
            name='profile',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='hobbies.profile'),
        ),
        migrations.AddField(
            model_name='user',
